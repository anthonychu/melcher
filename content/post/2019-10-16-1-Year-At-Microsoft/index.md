...
prioritizing the right things and communicate customer feedback that matters
* evangelizing Azure
* help with pilots
...
When I joined Microsoft, I was worried that I cannot contribute to the community as much as I did back when I was a partner and an MVP. But quite the opposite, some tasks like getting a decent meeting room for a community event is now way easier.
So last year we hosted, [AzureSaturday Munich](https://AzureSaturday.de), the third time in the Microsoft Office in Munich - and supporting this as an employee was more efficient.
...
[careers.microsoft.com](https://aka.ms/TechSalesCareers)
